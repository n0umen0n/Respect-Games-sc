...
import "./CommunityGovernanceMultiSig.sol";
/*
...
contract CommunityGovernanceProfiles is ICommunityGovernanceProfiles, Ownable {
    ...
    CommunityGovernanceMultiSig public multiSigContract;
    ...
    function setMultiSigContract(address _multiSigContractAddress) public onlyOwner {
        multiSigContract = CommunityGovernanceMultiSig(_multiSigContractAddress);
    }
    ...
    function setRespectToDistribute(uint256 _communityId, uint256 _amount) public {
    ...
    function removeMember(uint256 _communityId, address _member) public {
        require(msg.sender == address(multiSigContract), "Only MultiSig contract can call this function");
        Community storage community = communities[_communityId];
    ...
    function mintTokens(uint256 _communityId, uint256 _amount) public {
        require(msg.sender == address(multiSigContract), "Only MultiSig contract can call this function");
        Community storage community = communities[_communityId];
