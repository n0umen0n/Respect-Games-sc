...
contract CommunityGovernanceMultiSigImplementation is Initializable, OwnableUpgradeable, CommunityGovernanceMultiSigStorage, ICommunityGovernanceMultiSig {
...
function executeProposal(uint256 _communityId, uint256 _proposalId) internal {
    ...
    function mintTokens(uint256 _communityId, uint256 _amount) internal {
     (
        ...
        require(tokenAddress != address(0), "Community token not found");        ICommunityToken token = ICommunityToken(tokenAddress);
